...
class SelfRecordForm(forms.Form):
    ...
    object_id = forms.CharField(required=True, label=_('activity unique identifier'), widget=forms.TextInput(attrs={'class':'form-control',}), help_text=_('could be an absolute or relative URL, a URI, a DOI, an ISBN code or the like'),)
    ...
    context_object_id = forms.CharField(required=True, label=_('contextual activity unique identifier'), widget=forms.TextInput(attrs={'class':'form-control',}), help_text=_('the unique id of the related activity; could be an absolute or relative URL, a URI, a DOI, an ISBN code or the like'),)
