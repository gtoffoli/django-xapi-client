...
xapi_activities = {
    ...
    'document': {'type': 'http://activitystrea.ms/schema/1.0/file',
        ...
        'description': {"en-US": "Represents a document of any type. For instance, a file in a folder or a file image in other type of memory.",},
    },
    'text': {'type': 'http://commonspaces.eu/activitytype/text',
        'display': {"en-US": "text", "it": "testo"},
        'description': {"en-US": "Represents a text of any type. For instance, the text entered by the user or extracted from a web page.",},
    },
